...
function Footer() {
    return (
        <footer className="bg-[#15161b] dark:bg-gray-900 text-white/65">
            <div className="container p-6 mx-auto max-w-[1450px]">
                <div className="lg:flex">
                    ...
                    <div className="mt-6 lg:mt-0 lg:flex-1">
                        <div className="flex justify-between sm:grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
