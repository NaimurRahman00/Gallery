  ...
  return (
    <div>
      <div className="w-full max-w-[160px] space-y-3 rounded-md bg-white shadow-lg dark:bg-[#18181B] overflow-hidden group">
        <div className="relative flex h-60 w-full justify-center lg:h-[260px]">
          {/* Price Tag */}
          <div className="absolute left-4 right-4 top-4 flex justify-between">
            ...
            <span className="rounded shadow-xl shadow-black bg-[#ffc107] px-2 py-0.5 h-fit font-bold text-xs text-black">
              HD
            </span>
          </div>

          {/* Movie Title */}
          <div className="absolute left-0 right-0 top-0 bottom-0 flex flex-col justify-end text-white font-bold leading-4 text-center">
            <h1 className="bg-gradient-to-t from-black/80 to-black/0 pt-8 pb-3">
              {name}
            </h1>
          </div>
